...
public:
	...
	Reboot* getReboot();
	 ////////// Modification depuis la derni�re fois pour r�cup�rer cette information
	...
	////////// Modification depuis la derni�re fois pour modifier cette information
...
private:
	...
	/**
	 * Cet attribut correspond � la temp�rature du cube, entre les cartes.
	 */

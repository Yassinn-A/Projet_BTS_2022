...
${OBJECTDIR}/_ext/5ee0878/buttons.o: ../cppGPIO/src/buttons.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/buttons.o ../cppGPIO/src/buttons.cpp

${OBJECTDIR}/_ext/5ee0878/gpio.o: ../cppGPIO/src/gpio.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5ee0878
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/gpio.o ../cppGPIO/src/gpio.cpp

${OBJECTDIR}/_ext/5ee0878/i2c.o: ../cppGPIO/src/i2c.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5ee0878
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/i2c.o ../cppGPIO/src/i2c.cpp

${OBJECTDIR}/_ext/5ee0878/lcd.o: ../cppGPIO/src/lcd.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5ee0878
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/lcd.o ../cppGPIO/src/lcd.cpp

${OBJECTDIR}/_ext/5ee0878/output.o: ../cppGPIO/src/output.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5ee0878
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/output.o ../cppGPIO/src/output.cpp

${OBJECTDIR}/_ext/5ee0878/tools.o: ../cppGPIO/src/tools.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/5ee0878
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5ee0878/tools.o ../cppGPIO/src/tools.cpp

${OBJECTDIR}/bombardement.o: bombardement.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bombardement.o bombardement.cpp
